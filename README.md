...
def sese(s):
        ...
        if type == "0070" : # TH
                ...
                t = int(time.time())
                print "temperature %d %.2f nodeid=%d" % ( t, v1, bigEndian( nodeID ) )	#현재시간 온도 nodeID
		insert("temperature", bigEndian( nodeID ), v1)	#metric_name:temperature
